...
const BOOK_MAP = {
  ...
  '1KI': '1Kgs','2KI': 'Kings', // app uses 'Kings' dir for 2 Kings (not '2Kgs')
  '1CH': '1Chr','2CH': '2Chr',EZR: 'Ezra',
  ...
  // NT (listed for USFM completeness — Brenton Septuagint does not cover NT;
  // these entries produce zero results with the current eBible source)
